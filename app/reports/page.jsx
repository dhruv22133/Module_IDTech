...
const DATA = [
  ...
  { id:6,tagId:"48464D000006",code:"MLD-0512",name:"A-Pillar Cover RH",uom:"Nos",bom:"BOM-512",status:"Active",desc:"A-pillar cover RH blow mould",assetType:"Blow Mould",cat:"Die And Moulds",subCat:"Blow",plant:"Plant B - Pune",dept:"Production",loc:"Shop Floor A",vendor:"Bharat Engineering Works",shots:220000,maxShots:500000,lifePct:44,cost:1400000,bookVal:700000,age:3.2,capDate:"2022-01-08",condition:"Good",lastMaint:"2025-01-05",weight:4800,costCenter:"CC-002" },
  { id:7,tagId:"48464D000007",code:"MLD-0634",name:"Rear Bumper Assembly",uom:"Nos",bom:"BOM-634",status:"End of Life",desc:"Rear bumper compression mould",assetType:"Compression Mould",cat:"Die And Moulds",subCat:"Compression",plant:"Plant A - Mumbai",dept:"Production",loc:"Warehouse 2",vendor:"Precision Tooling Co.",shots:495000,maxShots:500000,lifePct:99,cost:3200000,bookVal:96000,age:9.1,capDate:"2016-02-14",condition:"Critical",lastMaint:"2024-11-30",weight:6800,costCenter:"CC-001" },
  { id:8,tagId:"48464D000008",code:"MLD-0721",name:"Console Side Panel",uom:"Nos",bom:"BOM-721",status:"Active",desc:"Console side panel injection",assetType:"Injection Mould",cat:"Die And Moulds",subCat:"Injection",plant:"Plant B - Pune",dept:"Production",loc:"Shop Floor A",vendor:"Elite Mould Makers",shots:310000,maxShots:500000,lifePct:62,cost:1750000,bookVal:437500,age:4.8,capDate:"2020-07-22",condition:"Good",lastMaint:"2025-02-18",weight:3400,costCenter:"CC-002" },
  { id:9,tagId:"48464D000009",code:"MLD-0819",name:"Fender Extension LH",uom:"Nos",bom:"BOM-819",status:"At Vendor",desc:"Fender extension LH die cast",assetType:"Die Cast Mould",cat:"Die And Moulds",subCat:"Die Cast",plant:"Plant C - Nashik",dept:"Tool Room",loc:"Vendor - Star Jobwork",vendor:"Star Jobwork Solutions",shots:497800,maxShots:500000,lifePct:99.6,cost:2100000,bookVal:42000,age:7.8,capDate:"2017-06-30",condition:"Critical",lastMaint:"2024-10-12",weight:5400,costCenter:"CC-003" },
  { id:10,tagId:"48464D000010",code:"MLD-0923",name:"Tailgate Inner Panel",uom:"Nos",bom:"BOM-923",status:"Retired",desc:"Tailgate inner panel injection",assetType:"Injection Mould",cat:"Die And Moulds",subCat:"Injection",plant:"Plant A - Mumbai",dept:"Store",loc:"Warehouse 1",vendor:"Precision Tooling Co.",shots:492000,maxShots:500000,lifePct:98.4,cost:2450000,bookVal:122500,age:8.5,capDate:"2016-09-18",condition:"Critical",lastMaint:"2024-09-05",weight:4100,costCenter:"CC-001" },
];

// Audit data
const AUDIT_DATA = [
  { id:"AUD-0012",vendor:"Precision Tooling Co.",city:"Pune",date:"05 Mar 2025",operator:"Rajesh Kumar",device:"Zebra MC3300",expected:4,found:3,notFound:1,extra:0,matchPct:75,
    moulds:[
      {mid:"MLD-0042",name:"Bumper Front LH",found:true,tag:"48464D000001",time:"10:32",cond:"Good",photo:true,remark:""},
      {mid:"MLD-0087",name:"Grille Centre",found:true,tag:"48464D000004",time:"10:35",cond:"Good",photo:true,remark:""},
      {mid:"MLD-0634",name:"Rear Bumper Assembly",found:true,tag:"48464D000007",time:"10:38",cond:"Fair",photo:true,remark:"Minor rust"},
      {mid:"MLD-0923",name:"Tailgate Inner Panel",found:false,tag:"48464D000010",time:"-",cond:"-",photo:false,remark:"NOT FOUND"},
    ]},
  { id:"AUD-0013",vendor:"Elite Mould Makers",city:"Mumbai",date:"04 Mar 2025",operator:"Vikram Joshi",device:"Samsung XCover",expected:3,found:3,notFound:0,extra:0,matchPct:100,
    moulds:[
      {mid:"MLD-0118",name:"Dashboard Panel RH",found:true,tag:"48464D000002",time:"02:05",cond:"Good",photo:true,remark:""},
      {mid:"MLD-0203",name:"Door Trim Inner LH",found:true,tag:"48464D000003",time:"02:08",cond:"Fair",photo:true,remark:""},
      {mid:"MLD-0819",name:"Fender Extension LH",found:true,tag:"48464D000009",time:"02:12",cond:"Good",photo:true,remark:""},
    ]},
  { id:"AUD-0014",vendor:"Bharat Engineering",city:"Nashik",date:"03 Mar 2025",operator:"Rajesh Kumar",device:"Zebra MC3300",expected:2,found:2,notFound:0,extra:0,matchPct:100,
    moulds:[
      {mid:"MLD-0311",name:"Headlamp Bezel RH",found:true,tag:"48464D000005",time:"09:05",cond:"Under Repair",photo:true,remark:"Ejector pin work"},
      {mid:"MLD-0512",name:"A-Pillar Cover RH",found:true,tag:"48464D000006",time:"09:10",cond:"Good",photo:true,remark:"Ready for return"},
    ]},
];

// ── CSS matching reference screenshot exactly ──
const CSS = `
...
/* FILTER FORM — matching reference exactly */
...
/* EXPORT BAR — exact match to reference */
...
/* DATA TABLE — exact match to reference screenshot */
.tw{background:#fff;border:1px solid #bbb;border-top:none;overflow-x:auto;margin-bottom:0}
table{width:100%;border-collapse:collapse;min-width:1200px}
thead th{padding:10px 10px;text-align:left;font-size:11px;font-weight:700;color:#fff;background:#4a5d8e;border:1px solid #6a7db0;white-space:normal;cursor:pointer;user-select:none;position:sticky;top:0;z-index:1;vertical-align:middle;line-height:1.35}
thead th:hover{background:#3d5080}
thead th .sa{margin-left:3px;font-size:8px;opacity:.7}
tbody td{padding:8px 10px;font-size:12px;color:#333;border:1px solid #ddd;white-space:normal;vertical-align:top;line-height:1.4;background:#fff}
...
/* AUDIT */
.ag{display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px;margin-bottom:16px}
.ac{background:#fff;border:1.5px solid #ddd;border-radius:6px;padding:16px;cursor:pointer;transition:all .12s}
.ac:hover{border-color:#3b5bdb;box-shadow:0 3px 12px rgba(0,0,0,.08)}
.ac.on{border-color:#3b5bdb;box-shadow:0 0 0 2px rgba(59,91,219,.15)}
.ac-v{font-size:14px;font-weight:800;color:#111}
.ac-m{font-size:11px;color:#6b7280;margin-top:2px}
.ac-stats{display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:5px;margin-top:10px}
.ac-st{text-align:center;padding:5px;background:#f4f6f9;border-radius:4px;border:1px solid #e5e7eb}
.ac-st-n{font-size:15px;font-weight:800}
.ac-st-l{font-size:8px;font-weight:700;color:#888;text-transform:uppercase}
.ac-bar{margin-top:8px;height:5px;background:#e5e7eb;border-radius:3px;overflow:hidden}
.ac-fill{height:100%;border-radius:3px}
.ac-tag{display:inline-flex;font-size:10px;font-weight:700;padding:2px 8px;border-radius:3px;margin-top:8px}
.ftag{font-size:10px;font-weight:700;color:#fff;padding:2px 8px;border-radius:3px;display:inline-block}
...
const COLS={
  ...
  maintenance:[{k:"id",l:"Id",w:40},{k:"code",l:"Mould ID",w:90},{k:"name",l:"Name",w:130},{k:"status",l:"Status",w:90},{k:"condition",l:"Condition",w:80},{k:"lastMaint",l:"Last Maint.",w:90},{k:"plant",l:"Plant",w:100},{k:"dept",l:"Dept",w:80}],
  transfer_log:[{k:"id",l:"Id",w:40},{k:"code",l:"Mould ID",w:90},{k:"name",l:"Name",w:130},{k:"vendor",l:"Vendor",w:150},{k:"status",l:"Status",w:90},{k:"loc",l:"Location",w:130},{k:"plant",l:"Plant",w:100}],
  scrap_disposal:[{k:"id",l:"Id",w:40},{k:"code",l:"Mould ID",w:90},{k:"name",l:"Name",w:130},{k:"status",l:"Status",w:90},{k:"condition",l:"Condition",w:80},{k:"cost",l:"Asset Value",w:90},{k:"bookVal",l:"Book Value",w:90},{k:"lifePct",l:"Life %",w:60}],
...
export default function ReportsModule(){
  ...
  const applyFilters=()=>{
    ...
    if(fLoc){if(fLoc==="At Vendor")d=d.filter(m=>m.loc.startsWith("Vendor"));else d=d.filter(m=>m.loc.includes(fLoc))}
    if(fStatus)d=d.filter(m=>m.status===fStatus);
    if(fVendor)d=d.filter(m=>m.vendor===fVendor);
    if(fDept)d=d.filter(m=>m.dept===fDept);
    setFiltered(d);setPg(1);
  };
  const resetF=()=>{setFTag("");setFCode("");setFName("");setFType("");setFPlant("");setFLoc("");setFStatus("");setFVendor("");setFDept("");setFFrom("");setFTo("");setFiltered(DATA);setPg(1)};
  ...
  const renderCell=(m,c)=>{
    const v=m[c.k];
    if(v==null) return "-";
    if(c.k==="cost"||c.k==="bookVal")return fmt(v);
    if(c.k==="shots"||c.k==="maxShots")return v.toLocaleString("en-IN");
    return String(v);
  };
  ...
  return(<>
    ...
    <div className="shell">
      <div className="sb">
        ...
        <div className="sb-foot"><div className="sb-row"><div className="sb-av">{currentUserInitials}</div><div><div style={{fontSize:12,fontWeight:600,color:"#fff"}}>{user.name}</div><div style={{fontSize:10,color:"rgba(255,255,255,.5)"}}>{user.role}</div></div></div></div>
      </div>
      <div className="mn">
        <div className="top"><div className="top-t">Reports</div></div>
        <div className="rl">
          {/* Report sidebar */}
          <div className="rs">
            ...
            {!isAudit&&<>
              ...
              <div className="fcard">
                ...
                <div className="fcard-b">
                  ...
                  <div className="factions"><button className="fbtn fbtn-go" onClick={applyFilters}>Submit</button></div>
                </div>
              </div>
            ...
            {isAudit&&<>
                  ...
                  {AUDIT_DATA.map(a=>(
                    <div key={a.id} className="ac" onClick={()=>setSelAudit(a)}>
                      ...
                      <div className="ac-stats">
                        <div className="ac-st"><div className="ac-st-n">{a.expected}</div><div className="ac-st-l">Expected</div></div>
                        <div className="ac-st"><div className="ac-st-n" style={{color:"#198754"}}>{a.found}</div><div className="ac-st-l">Found</div></div>
                        <div className="ac-st"><div className="ac-st-n" style={{color:a.notFound?"#dc3545":"#198754"}}>{a.notFound}</div><div className="ac-st-l">Not Found</div></div>
                        <div className="ac-st"><div className="ac-st-n" style={{color:a.extra?"#fd7e14":"#888"}}>{a.extra}</div><div className="ac-st-l">Extra</div></div>
                      </div>
                      <div className="ac-bar"><div className="ac-fill" style={{width:`${a.matchPct}%`,background:a.matchPct===100?"#198754":"#dc3545"}}/></div>
                      <div className="ac-tag" style={{background:a.matchPct===100?"#d1e7dd":"#f8d7da",color:a.matchPct===100?"#0f5132":"#842029"}}>{a.matchPct}% Match</div>
                    </div>
                  ))}
                </div>
              </>}
              ...
              {selAudit&&<>
                ...
                <div style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:8,marginBottom:14}}>
                  {[["Expected",selAudit.expected,"#333"],["Found",selAudit.found,"#198754"],["Not Found",selAudit.notFound,selAudit.notFound?"#dc3545":"#198754"],["Extra",selAudit.extra,selAudit.extra?"#fd7e14":"#888"],["Match",selAudit.matchPct+"%",selAudit.matchPct===100?"#198754":"#dc3545"]].map(([l,v,c],i)=>(
                ...
                <div className="tw" style={{borderTop:"none"}}>
                  <table style={{minWidth:900}}>
                    <thead><tr><th>Status</th><th>Mould ID</th><th>Name</th><th>RFID Scanned</th><th>Tag ID</th><th>Scan Time</th><th>Condition</th><th>Photo</th><th>Remarks</th></tr></thead>
                    <tbody>
                      {selAudit.moulds.map((m,i)=>(
                        <tr key={i} style={{background:m.found?"#f0fdf4":"#fef2f2"}}>
                          <td>{m.found?<span className="ftag" style={{background:"#198754"}}>FOUND</span>:<span className="ftag" style={{background:"#dc3545"}}>NOT FOUND</span>}</td>
                          <td style={{fontWeight:700,color:"#3b5bdb"}}>{m.mid}</td>
                          <td style={{fontWeight:600}}>{m.name}</td>
                          <td>{m.scanned?<span style={{color:"#198754",fontWeight:600}}>Yes</span>:<span style={{color:"#dc3545",fontWeight:600}}>No</span>}</td>
                          <td style={{fontFamily:"monospace",fontSize:11}}>{m.tag}</td>
                          <td>{m.time}</td>
                          <td>{m.cond}</td>
                          <td>{m.photo?<span style={{color:"#0d6efd",fontWeight:600}}>📸 Yes</span>:"-"}</td>
                          <td style={{whiteSpace:"normal",maxWidth:180,lineHeight:1.4}}>{m.remark||"-"}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
