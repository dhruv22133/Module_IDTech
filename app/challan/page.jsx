...
// ══════════════════════════════════════════════════════════════
const MOULDS = [
  { id:"MLD-0042", name:"Bumper Front LH",       type:"Injection Mould", plant:"Plant A – Mumbai",     vendor:null,          location:"manufacturer", locationName:"Tata Moulds Pvt Ltd"      },
  { id:"MLD-0118", name:"Dashboard Panel RH",    type:"Injection Mould", plant:"Plant B – Pune",       vendor:"VND-002",     location:"vendor",       locationName:"Elite Mould Makers"        },
  { id:"MLD-0203", name:"Door Trim Inner LH",    type:"Blow Mould",      plant:"Plant A – Mumbai",     vendor:null,          location:"plant",        locationName:"Plant A – Mumbai"          },
  { id:"MLD-0087", name:"Grille Centre",          type:"Die Cast Mould",  plant:"Plant C – Nashik",     vendor:"VND-001",     location:"vendor",       locationName:"Precision Tooling Co."     },
  { id:"MLD-0311", name:"Headlamp Bezel RH",     type:"Injection Mould", plant:"Plant D – Aurangabad", vendor:null,          location:"maintenance",  locationName:"Plant D – Maintenance Bay" },
  { id:"MLD-0512", name:"A-Pillar Cover RH",     type:"Blow Mould",      plant:"Plant B – Pune",       vendor:null,          location:"manufacturer", locationName:"Bharat Engineering Works"  },
  { id:"MLD-0634", name:"Rear Bumper Assembly",  type:"Compression Mould",plant:"Plant A – Mumbai",    vendor:"VND-003",     location:"vendor",       locationName:"Bharat Engineering Works"  },
  { id:"MLD-0721", name:"Console Side Panel",    type:"Injection Mould", plant:"Plant B – Pune",       vendor:null,          location:"plant",        locationName:"Plant B – Pune"            },
  { id:"MLD-0819", name:"Fender Extension LH",   type:"Die Cast Mould",  plant:"Plant C – Nashik",     vendor:"VND-004",     location:"vendor",       locationName:"Star Jobwork Solutions"    },
  { id:"MLD-0923", name:"Tailgate Inner Panel",  type:"Injection Mould", plant:"Plant A – Mumbai",     vendor:null,          location:"manufacturer", locationName:"Global Tool Craft"         },
];

const VENDORS = [
  { code:"VND-001", name:"Precision Tooling Co.",    city:"Pune",         contact:"Arvind Shah",   phone:"+91 98220 11234" },
  { code:"VND-002", name:"Elite Mould Makers",       city:"Mumbai",       contact:"Sunita Rao",    phone:"+91 99870 55678" },
  { code:"VND-003", name:"Bharat Engineering Works", city:"Nashik",       contact:"Raju Patil",    phone:"+91 94050 44321" },
  { code:"VND-004", name:"Star Jobwork Solutions",   city:"Aurangabad",   contact:"Meena Kulkarni",phone:"+91 93700 88900" },
];

const MANUFACTURERS = [
  { code:"MFG-001", name:"Tata Moulds Pvt Ltd",      city:"Pune"    },
  { code:"MFG-002", name:"Bharat Engineering Works", city:"Nashik"  },
  { code:"MFG-003", name:"Elite Mould Makers",       city:"Mumbai"  },
  { code:"MFG-004", name:"Global Tool Craft",        city:"Chennai" },
];
...
const TRANSFER_REASONS = [
  "Jobwork","Repair","Preventive Maintenance","Corrective Maintenance",
  "Inter-Plant Move","Trial Run","Quality Inspection","Scrapping","Warranty Return","New Mould Receipt",
];

const USERS = {
  maker:    { id:"USR-001", name:"Rajesh Kumar",   role:"Maker",    avatar:"RK", dept:"Production" },
  approver: { id:"USR-002", name:"Sunita Rao",     role:"Approver", avatar:"SR", dept:"Operations" },
};

// Auto challan counter
let challanCounter = 157;
const nextChallan = () => `CHN-2025-${String(++challanCounter).padStart(4,"0")}`;

// ── seed transfers ──────────────────────────────────────────
const SEED = [
  {
    id:"TRF-2025-0892", challanNo:"CHN-2025-0155",
    mouldId:"MLD-0042", mouldName:"Bumper Front LH", mouldType:"Injection Mould",
    transferType:"vendor_plant", fromType:"vendor", fromName:"Precision Tooling Co.", fromCode:"VND-001",
    toType:"plant", toName:"Plant A – Mumbai",
    reason:"Jobwork", expectedReturn:"2025-04-20",
    vehicleNo:"MH-12-AB-4567", consignmentNo:"CONS-20250304-001",
    remarks:"Jobwork complete, returning to plant for assembly",
    status:"Pending Approval",
    maker:USERS.maker, approver:null,
    createdAt:"04 Mar 2025, 10:32 AM",
    challanImages:[], approvalRemark:"",
    timeline:[{ event:"Transfer Initiated", by:"Rajesh Kumar", at:"04 Mar 2025, 10:32 AM", note:"Submitted for approval" }]
  },
  {
    id:"TRF-2025-0891", challanNo:"CHN-2025-0154",
    mouldId:"MLD-0203", mouldName:"Door Trim Inner LH", mouldType:"Blow Mould",
    transferType:"plant_vendor", fromType:"plant", fromName:"Plant A – Mumbai",
    toType:"vendor", toName:"Elite Mould Makers", toCode:"VND-002",
    reason:"Repair", expectedReturn:"2025-03-28",
    vehicleNo:"MH-04-CD-8821", consignmentNo:"CONS-20250303-002",
    remarks:"Cavity 2 crack – urgent repair required",
    status:"In Transit",
    maker:USERS.maker, approver:USERS.approver,
    createdAt:"03 Mar 2025, 02:15 PM",
    challanImages:[], approvalRemark:"Verified and approved",
    timeline:[
      { event:"Transfer Initiated", by:"Rajesh Kumar", at:"03 Mar 2025, 02:15 PM", note:"Submitted for approval" },
      { event:"Approved", by:"Sunita Rao", at:"03 Mar 2025, 04:30 PM", note:"Verified and approved" },
      { event:"In Transit", by:"Rajesh Kumar", at:"04 Mar 2025, 09:00 AM", note:"Dispatched via Mahindra Logistics" },
    ]
  },
  {
    id:"TRF-2025-0889", challanNo:"CHN-2025-0152",
    mouldId:"MLD-0087", mouldName:"Grille Centre", mouldType:"Die Cast Mould",
    transferType:"mfg_vendor", fromType:"manufacturer", fromName:"Tata Moulds Pvt Ltd", fromCode:"MFG-001",
    toType:"vendor", toName:"Precision Tooling Co.", toCode:"VND-001",
    reason:"Trial Run", expectedReturn:"2025-03-22",
    vehicleNo:"MH-14-GH-3311", consignmentNo:"CONS-20250302-001",
    remarks:"New mould trial at vendor facility",
    status:"Closed",
    maker:USERS.maker, approver:USERS.approver,
    createdAt:"02 Mar 2025, 11:45 AM",
    challanImages:[], approvalRemark:"Approved for trial",
    timeline:[
      { event:"Transfer Initiated", by:"Rajesh Kumar", at:"02 Mar 2025, 11:45 AM", note:"Submitted" },
      { event:"Approved", by:"Sunita Rao", at:"02 Mar 2025, 01:00 PM", note:"Approved for trial" },
      { event:"In Transit", by:"Rajesh Kumar", at:"02 Mar 2025, 03:00 PM", note:"Dispatched" },
      { event:"Receipt Acknowledged", by:"Sunita Rao", at:"03 Mar 2025, 10:00 AM", note:"Received at vendor" },
      { event:"Closed", by:"Sunita Rao", at:"03 Mar 2025, 10:05 AM", note:"Transfer closed" },
    ]
  },
  {
    id:"TRF-2025-0887", challanNo:null,
    mouldId:"MLD-0311", mouldName:"Headlamp Bezel RH", mouldType:"Injection Mould",
    transferType:"vendor_maint", fromType:"vendor", fromName:"Star Jobwork Solutions", fromCode:"VND-004",
    toType:"maintenance", toName:"Plant D – Aurangabad Maintenance Bay",
    reason:"Corrective Maintenance", expectedReturn:"2025-03-18",
    vehicleNo:"", consignmentNo:"",
    remarks:"Incorrect mould, please re-initiate with correct ID",
    status:"Rejected",
    maker:USERS.maker, approver:USERS.approver,
    createdAt:"01 Mar 2025, 09:10 AM",
    challanImages:[], approvalRemark:"Incorrect mould selected – please re-initiate",
    timeline:[
      { event:"Transfer Initiated", by:"Rajesh Kumar", at:"01 Mar 2025, 09:10 AM", note:"Submitted" },
      { event:"Rejected", by:"Sunita Rao", at:"01 Mar 2025, 11:00 AM", note:"Incorrect mould selected" },
    ]
  },
];
...
const WORKFLOW_STEPS = [
  { key:"draft",    label:"Initiated",   role:"Maker"    },
  { key:"approval", label:"Approval",    role:"Approver" },
  { key:"transit",  label:"In Transit",  role:"Maker"    },
  { key:"receipt",  label:"Receipt Ack", role:"Approver" },
...
.sb-brand{padding:18px 16px 14px;border-bottom:1px solid rgba(255,255,255,.1);z-index:1;position:relative}
.sb-logo-row{display:flex;align-items:center;gap:9px}
.sb-logo-box{width:32px;height:32px;background:rgba(255,255,255,.18);border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0}
.sb-brand-name{font-size:13px;font-weight:700;color:#fff}
.sb-brand-name span{font-weight:400;opacity:.7}
.sb-brand-sub{font-size:9px;color:rgba(255,255,255,.38);margin-top:1px}
...
.srch-inp::placeholder{color:#b8c4ce}
...
.btn-p{background:linear-gradient(135deg,#4f46e5,#7c3aed);color:#fff;box-shadow:0 4px 12px rgba(91,43,224,.24)}
.btn-p:hover{opacity:.92;transform:translateY(-1px)}
.btn-o{background:#fff;color:#374151;border:1.5px solid #e5e7eb}
.btn-o:hover{border-color:#6366f1;color:#4f46e5}
.btn-green{background:linear-gradient(135deg,#059669,#047857);color:#fff;box-shadow:0 4px 11px rgba(5,150,105,.24)}
.btn-green:hover{opacity:.92}
.btn-red{background:linear-gradient(135deg,#dc2626,#b91c1c);color:#fff;box-shadow:0 4px 11px rgba(220,38,38,.24)}
.btn-red:hover{opacity:.92}
.btn-cyan{background:linear-gradient(135deg,#0891b2,#0e7490);color:#fff;box-shadow:0 4px 11px rgba(8,145,178,.24)}
.btn-cyan:hover{opacity:.92}
.btn-amber{background:linear-gradient(135deg,#d97706,#b45309);color:#fff;box-shadow:0 4px 11px rgba(217,119,6,.24)}
...
.mo-bx::-webkit-scrollbar{width:4px}
.mo-bx::-webkit-scrollbar-thumb{background:#e5e7eb;border-radius:2px}
...
.finp::placeholder{color:#b8c4ce;font-size:12px}
.finp.err{border-color:#ef4444;box-shadow:0 0 0 3px rgba(239,68,68,.07)}
...
.fta{border:1.5px solid #e5e7eb;border-radius:9px;padding:9px 12px;font-family:'Plus Jakarta Sans',sans-serif;font-size:12.5px;color:#111827;background:#f9fafb;outline:none;width:100%;resize:vertical;min-height:66px;transition:border-color .16s;line-height:1.55}
.fta:focus{border-color:#6366f1;background:#fff;box-shadow:0 0 0 3px rgba(99,102,241,.08)}
.fta::placeholder{color:#b8c4ce}
...
.mould-opt:last-child{border:none}
...
.mould-selected{background:#f0f4ff;border:1.5px solid #c7d2fe;border-radius:10px;padding:10px 13px;margin-top:8px;display:flex;align-items:center;justify-content:space-between;gap:12}
.ms-info{flex:1}
.ms-id{font-size:10.5px;font-weight:700;color:#4338ca;font-family:monospace}
.ms-name{font-size:13px;font-weight:700;color:#111827;margin-top:1px}
.ms-loc{font-size:11px;color:#6b7280;margin-top:2px}
.ms-clear{width:22px;height:22px;border-radius:5px;background:rgba(220,38,38,.1);display:flex;align-items:center;justify-content:center;cursor:pointer;color:#dc2626;font-size:12px;font-weight:700;flex-shrink:0;transition:background .12s}
.ms-clear:hover{background:rgba(220,38,38,.2)}
...
.img-upload-zone:hover,.img-upload-zone.drag{border-color:#6366f1;background:#f0f4ff}
...
.img-rm{position:absolute;top:4px;right:4px;width:18px;height:18px;border-radius:4px;background:rgba(0,0,0,.65);display:flex;align-items:center;justify-content:center;cursor:pointer;color:#fff;font-size:10px;font-weight:700}
.img-rm:hover{background:rgba(220,38,38,.9)}
.img-thumb-label{position:absolute;bottom:0;left:0;right:0;background:rgba(0,0,0,.6);color:#fff;font-size:9px;padding:3px 5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}

/* WORKFLOW STEPPER */
.wf-wrap{background:#fff;border-radius:13px;border:1px solid #e5e7eb;padding:16px 20px;margin-bottom:16px;box-shadow:0 1px 4px rgba(0,0,0,.04)}
.wf-inner{display:flex;align-items:center}
.wf-step{display:flex;align-items:center;gap:7px;flex-shrink:0}
.wf-circle{width:30px;height:30px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;flex-shrink:0;transition:all .2s}
...
.wf-line{flex:1;height:2px;background:#e5e7eb;margin:0 6px;min-width:14px;transition:background .3s}
...
.dg4{grid-template-columns:1fr 1fr 1fr 1fr}
.di .dlbl{font-size:9.5px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:#9ca3af;margin-bottom:3px}
.di .dval{font-size:12.5px;font-weight:600;color:#111827}
.mono-badge{font-family:monospace;font-size:12px;font-weight:700;background:#eef2ff;color:#4338ca;padding:2px 8px;border-radius:5px;display:inline-block}
.reason-badge{font-size:11px;font-weight:700;padding:2px 9px;border-radius:20px;border:1px solid;display:inline-flex;align-items:center}
...
.chl-logo span{opacity:.65;font-weight:400}
...
.chl-grid-3{grid-template-columns:1fr 1fr 1fr}
...
.chl-stamp{width:54px;height:54px;border-radius:50%;border:2.5px solid #15803d;display:flex;align-items:center;justify-content:center;color:#15803d;font-size:8.5px;font-weight:800;text-align:center;padding:5px;line-height:1.35}
.chl-img-row{display:flex;flex-wrap:wrap;gap:8px;margin-top:10px}
.chl-img{width:80px;height:60px;object-fit:cover;border-radius:7px;border:1.5px solid #e5e7eb}
...
.role-maker{background:#eef2ff;color:#4338ca;border:1px solid #c7d2fe}
.role-approver{background:#f0fdf4;color:#15803d;border:1px solid #bbf7d0}

/* TOAST */
.toast{position:fixed;bottom:20px;right:20px;background:#1f2937;color:#fff;padding:11px 17px;border-radius:12px;font-size:12.5px;font-weight:500;z-index:4000;display:flex;align-items:center;gap:8px;box-shadow:0 8px 28px rgba(0,0,0,.26);animation:tIn .24s ease;min-width:260px}
@keyframes tIn{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}
.t-ok{border-left:4px solid #10b981}
.t-err{border-left:4px solid #ef4444}
.t-inf{border-left:4px solid #6366f1}
...
// ══════════════════════════════════════════════════════════════
function bgFor(s){const c=["#4f46e5","#0891b2","#059669","#d97706","#dc2626","#7c3aed","#0d9488","#b45309"];let h=0;for(let i=0;i<s.length;i++)h=s.charCodeAt(i)+((h<<5)-h);return c[Math.abs(h)%c.length];}
...
function useToast(){
  ...
  const node=t&&<div className={`toast t-${t.type}`}>{t.type==="ok"?"✅":t.type==="err"?"❌":t.type==="warn"?"⚠️":"ℹ️"} {t.msg}</div>;
  return[show,node];
}
...
// ══════════════════════════════════════════════════════════════
function MouldSearch({value,onChange,error}){
  const [q,setQ]=useState("");
  const [open,setOpen]=useState(false);
  const wrapRef=useRef(null);
  const selected=MOULDS.find(m=>m.id===value);
  const results=MOULDS.filter(m=>!q||(m.id.toLowerCase().includes(q.toLowerCase())||m.name.toLowerCase().includes(q.toLowerCase())));
  return <div className="mould-search-wrap" ref={wrapRef}>
    {!selected?<>
...
function ImageUpload({images,onChange}){
  ...
  const handleFiles=useCallback((files)=>{
    ...
    const readers=arr.map(file=>new Promise(res=>{
      ...
      r.onload=(e)=>res({url:e.target.result,name:file.name,size:file.size});
  ...
  return <div>
    <div className={`img-upload-zone${drag?" drag":""}`}
      ...
      <div className="iuz-sub">Drag & drop or click to browse · JPG, PNG, PDF images accepted</div>
  ...
  return <div className="chl-doc">
    ...
    <div className="chl-body">
      ...
      <div className="chl-sec">
        ...
        <div className="chl-grid chl-grid-3">
      ...
      {/* Challan images */}
      {tr.challanImages&&tr.challanImages.length>0&&<div className="chl-sec">
        <div className="chl-sec-t">Attached Documents ({tr.challanImages.length})</div>
        <div className="chl-img-row">
          {tr.challanImages.map((img,i)=><img key={i} className="chl-img" src={img.url} alt={img.name}/>)}
        </div>
      </div>}
    </div>
...
//  NEW TRANSFER MODAL
// ══════════════════════════════════════════════════════════════
function NewTransferModal({onClose,onSubmit,currentUser}){
  const [step,setStep]=useState(1); // 1=mould+type, 2=details, 3=logistics
  ...
  const selectedTT=TRANSFER_TYPES.find(t=>t.key===form.transferType);

  // When transfer type selected, pre-fill "from" options based on current mould location
  ...
  const getFromOptions=()=>{
    if(form.fromType==="manufacturer")return MANUFACTURERS;
    if(form.fromType==="vendor")return VENDORS;
    if(form.fromType==="plant")return PLANTS.map(p=>({code:p,name:p}));
    return[];
  };
  const getToOptions=()=>{
    if(form.toType==="vendor")return VENDORS;
    if(form.toType==="plant")return PLANTS.map(p=>({code:p,name:p}));
    if(form.toType==="manufacturer")return MANUFACTURERS;
    return[];
  };
  ...
  const submit=(isDraft)=>{
    const challanNo=nextChallan();
    const now=new Date().toLocaleString("en-IN",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"});
    const t={
      id:`TRF-2025-${String(Math.floor(Math.random()*9000)+1000)}`,
      challanNo,
      ...
      maker:currentUser,approver:null,approvalRemark:"",
      createdAt:now,
  ...
  return <div className="mo-ov" onClick={e=>e.target===e.currentTarget&&onClose()}>
    <div className="mo-bx" style={{maxWidth:700}}>
      ...
      <div className="mo-body">
        ...
        {/* STEP 1: Mould & Transfer Type */}
        {step===1&&<div className="fade-in">
          <div className="fsec">🔩 Select Mould</div>
          <MouldSearch value={form.mouldId} onChange={v=>sf("mouldId",v)} error={errs.mouldId}/>
            ...
            {form.fromType==="maintenance"
              ...
              :<select className={`fsel${errs.fromName?" err":""}`}
                ...
                onChange={e=>{
                  ...
                  const found=opts.find(o=>(o.code||o)===e.target.value);
                  sf("fromCode",e.target.value);
                  sf("fromName",found?.name||(typeof found==="string"?found:e.target.value));
                }}>
                <option value="">— Select {form.fromType} —</option>
                {getFromOptions().map(o=>{
                  const code=o.code||o;const name=o.name||o;
                  return <option key={code} value={code}>{name}{o.city?` (${o.city})`:""}</option>;
                })}
              </select>
            }
          ...
          {form.toType!=="maintenance"?<div style={{marginBottom:12}}>
            ...
            <select className={`fsel${errs.toName?" err":""}`}
              ...
              onChange={e=>{
                ...
                sf("toName",found?.name||(typeof found==="string"?found:e.target.value));
              }}>
        ...
        {step===3&&<div className="fade-in">
          ...
          {/* Auto-generated challan no preview */}
...
//  VIEW / ACTION MODAL
// ══════════════════════════════════════════════════════════════
function ViewModal({transfer:initTr,allTransfers,onClose,onUpdate,currentRole,currentUser}){
  const tr=allTransfers.find(t=>t.id===initTr.id)||initTr;
  const [mode,setMode]=useState("view"); // view|approve|reject|transit|receipt
  const [remark,setRemark]=useState("");
  const [remarkErr,setRemarkErr]=useState("");
  const [showChallan,setShowChallan]=useState(false);

  const canApprove=currentRole==="Approver"&&tr.status==="Pending Approval";
  const canMarkTransit=currentRole==="Maker"&&tr.status==="Approved";
  const canAcknowledge=currentRole==="Approver"&&tr.status==="In Transit";
  const canClose=currentRole==="Approver"&&tr.status==="Receipt Acknowledged";
          ...
          <div className="dg">
            <div><div className="dlbl" style={{marginBottom:6}}>Maker</div>
              <div className="uchip">
                ...
                <div><div className="uname">{tr.maker.name}</div><div className="urole">{tr.maker.dept}</div></div>
            ...
            <div><div className="dlbl" style={{marginBottom:6}}>Approver</div>
              {tr.approver?<div className="uchip" style={{background:"#f0fdf4",borderColor:"#bbf7d0"}}>
                ...
                <div><div className="uname">{tr.approver.name}</div><div className="urole">{tr.approver.dept}</div></div>
...
export default function MouldTransferPage(){
  ...
  const [transfers,setTransfers]=useState(SEED);
  const [activeTab,setActiveTab]=useState("transfers");
  const [currentRole,setCurrentRole]=useState("Maker");
  const [q,setQ]=useState("");
  ...
  const currentUser=currentRole==="Maker"
    ?{...USERS.maker,name:user.name,avatar:initials}
    :USERS.approver;
  ...
  const filtered=transfers.filter(t=>{
    ...
    return (!ql||[t.id,t.mouldId,t.mouldName,t.reason,t.challanNo||""].some(s=>s.toLowerCase().includes(ql)))
  ...
  return <>
        ...
        <div className="sb-brand">
          <div className="sb-logo-row">
            <div className="sb-logo-box">
              <svg width="18" height="18" viewBox="0 0 20 20" fill="none"><rect x="2" y="2" width="6" height="6" rx="1.5" fill="white" opacity=".9"/><rect x="12" y="2" width="6" height="6" rx="1.5" fill="white" opacity=".6"/><rect x="2" y="12" width="6" height="6" rx="1.5" fill="white" opacity=".6"/><rect x="12" y="12" width="6" height="6" rx="1.5" fill="white" opacity=".9"/><circle cx="10" cy="10" r="1.8" fill="white"/></svg>
            </div>
            <div><div className="sb-brand-name">MouldSys <span>Enterprise</span></div><div className="sb-brand-sub">Asset Management Platform</div></div>
          </div>
        </div>
        <div className="sb-nav">
          <div className="sb-sec">Main</div>
          {NAV_ITEMS.map(n=><div key={n.label} className={`sb-link${n.active?" on":""}`} onClick={()=>router.push(n.route)}><span className="sb-ico">{n.icon}</span>{n.label}</div>)}
        </div>
        <div className="sb-foot">
          <div className="sb-user">
            <div className="sb-av" style={{background:bgFor(currentUser.name)}}>{currentUser.avatar}</div>
            <div><div className="sb-uname">{currentUser.name}</div><div className="sb-urole">{currentRole}</div></div>
          </div>
        </div>
      </div>
      ...
      <div className="main">
        <div className="topbar">
          <div className="tb-left">
            ...
            <span style={{fontSize:10.5,background:currentRole==="Maker"?"#eef2ff":"#f0fdf4",color:currentRole==="Maker"?"#4338ca":"#15803d",padding:"2px 9px",borderRadius:6,fontWeight:700,border:`1px solid ${currentRole==="Maker"?"#c7d2fe":"#bbf7d0"}`,marginLeft:6}}>
              {currentRole==="Maker"?"📋 Maker":"✅ Approver"}
            </span>
          </div>
          <div className="tb-right">
            <span style={{fontSize:11.5,color:"#9ca3af",marginRight:4}}>Role:</span>
            <div className="role-sw">
              <button className={`role-btn${currentRole==="Maker"?" on":""}`} onClick={()=>setCurrentRole("Maker")}>📋 Maker</button>
              <button className={`role-btn${currentRole==="Approver"?" on":""}`} onClick={()=>setCurrentRole("Approver")}>✅ Approver</button>
            </div>
        ...
        <div className="content">
          ...
          <div className="main-tabs">
            ...
            <button className={`mtab${activeTab==="challan"?" on":""}`} onClick={()=>setActiveTab("challan")}>
              📄 Challan Register
          ...
          {activeTab==="transfers"&&<div className="fade-in">
            {/* Context banners */}
            {currentRole==="Approver"&&stats.pending>0&&(
            ...
            {currentRole==="Approver"&&stats.receipt>0&&(
            ...
            <div className="toolbar">
              ...
              <div style={{flex:1}}/>
              {currentRole==="Maker"&&<button className="btn btn-p" onClick={()=>setModal("new")}>+ Initiate Transfer</button>}
            </div>
                      ...
                      return <tr key={t.id} className={isPend?"pend":""}>
                        ...
                        <td>
                          <div className="acts">
                            ...
                            {currentRole==="Approver"&&t.status==="Pending Approval"&&(
                            ...
                            {t.status==="Approved"&&currentRole==="Maker"&&<button className="act c" title="Mark Transit" onClick={()=>{setSelected(t);setModal("view");}}>🚚</button>}
    ...
    {modal==="new"&&<NewTransferModal currentUser={currentUser} onClose={()=>setModal(null)} onSubmit={(t,isDraft)=>{
      setTransfers(ts=>[t,...ts]);setModal(null);
